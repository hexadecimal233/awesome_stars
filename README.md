...
*   [gjhenrique/yafl](https://github.com/gjhenrique/yafl) - A launcher for the True and Brave
...
*   [IvanSafonov/fanctl](https://github.com/IvanSafonov/fanctl) - Service to control fan speed on linux
...
*   [cookiengineer/antimiasma](https://github.com/cookiengineer/antimiasma) - :rocket: Miasma Malware Discovery and Mitigation Tool

*   [jmhobbs/terminal-parrot](https://github.com/jmhobbs/terminal-parrot) -

*   [axetroy/fslint](https://github.com/axetroy/fslint) -  文件系统命名风格检测工具 File system naming style lint
...
*   [tatanakots/FuckPrivateClient](https://github.com/tatanakots/FuckPrivateClient) - Obtain the configuration file from the private proxy client.
...
*   [KunMoe/kun-galgame-forum](https://github.com/KunMoe/kun-galgame-forum) - The CUTEST visualnovel / galgame forum! Built with Nuxt4, GO Fiber and PostgreSQL. Kun Visual Novel forum 6th generation!
...
*   [WentTheFox/SledgeHammerTime](https://github.com/WentTheFox/SledgeHammerTime) - Generate timestamp indicators for Discord chat messages
...
*   [ttys3/unrar.rs](https://github.com/ttys3/unrar.rs) - Rust library for extracting, listing and testing RAR archives.

*   [chiyuki0325/lyrica](https://github.com/chiyuki0325/lyrica) - 🎼 Linux desktop lyrics widget focused on simplicity and integration

*   [Kihara777/NixKits](https://github.com/Kihara777/NixKits) - 软件、补丁、NixOS 模块与 AI 编码助手的技能合集。

*   [enigo-rs/enigo](https://github.com/enigo-rs/enigo) - Cross platform input simulation in Rust

*   [bogardt/bullmq-rs](https://github.com/bogardt/bullmq-rs) - 🛠️BullMQ-inspired Rust library for advanced job & queue management with Redis. Supports job prioritization, delays, retries, workers, logging & queue monitoring. Open-source, fast, and reliable ideal for scalable background processing in modern Rust applications.

*   [denoland/deno](https://github.com/denoland/deno) - A modern runtime for JavaScript and TypeScript.

*   [joeblew999/orangevault](https://github.com/joeblew999/orangevault) - A Bitwarden-compatible password vault API, written in Rust, compiled to WebAssembly, and deployed on Cloudflare Workers.
...
*   [evanpurkhiser/libkeyfinder-sys](https://github.com/evanpurkhiser/libkeyfinder-sys) - Rust binding to the libkeyfinder library

*   [sdroege/ebur128](https://github.com/sdroege/ebur128) - Implementation of the EBU R128 loudness standard

*   [gitui-org/gitui](https://github.com/gitui-org/gitui) - Blazing 💥 fast terminal-ui for git written in rust 🦀

*   [beacondb/beacondb](https://github.com/beacondb/beacondb) - an in-development wireless geolocation database with public domain data dumps - alternative to Mozilla Location Services

*   [gpui-ce/gpui-ce](https://github.com/gpui-ce/gpui-ce) - GPUI – Community Edition

*   [lapce/floem](https://github.com/lapce/floem) - A native Rust UI library with fine-grained reactivity

*   [camilomatajira/jed](https://github.com/camilomatajira/jed) -

*   [audulus/rui](https://github.com/audulus/rui) - Declarative Rust UI library

*   [lenitain/fsmon](https://github.com/lenitain/fsmon) - A cli tool that records filesystem changes and which process executed them.

*   [naokiri/cskk](https://github.com/naokiri/cskk) - SKK (Simple Kana Kanji henkan) library

*   [goliajp/inputx](https://github.com/goliajp/inputx) - Inputx — Rust IME for macOS + iOS, Wubi + Pinyin Chinese input

*   [jmylchreest/rosec](https://github.com/jmylchreest/rosec) - A secrets daemon implementing the freedesktop.org Secret Service API with modular backend providers

*   [Shadowner/Infrarust](https://github.com/Shadowner/Infrarust) - High-Performance Minecraft Reverse Proxy in Rust

*   [HLLMR/stratum-dsp](https://github.com/HLLMR/stratum-dsp) -

*   [themankindproject/audiofp](https://github.com/themankindproject/audiofp) - Audio fingerprinting SDK: Wang landmarks, Panako triplets, Haitsma–Kalker, streaming, file decoding, AudioSeal watermark detection.

*   [cool-japan/oximedia](https://github.com/cool-japan/oximedia) - OxiMedia is the Sovereign Media Framework - A patent-free, memory-safe multimedia processing library written in pure Rust. Pure Rust reconstruction of both FFmpeg (multimedia processing) and OpenCV (computer vision) — unified in a single cohesive framework.

*   [not-jan/bpm-analyzer](https://github.com/not-jan/bpm-analyzer) -
...
*   [lxl66566/sing-dae](https://github.com/lxl66566/sing-dae) - Config converter between dae and sing-box

*   [imazen/imageflow](https://github.com/imazen/imageflow) - High-performance image manipulation for web servers. Includes imageflow\_server, imageflow\_tool, and libimageflow
...
*   [Rolv-Apneseth/clipvault](https://github.com/Rolv-Apneseth/clipvault) - Clipboard history manager for Wayland, inspired by cliphist
...
*   [hyprland-community/hyprland-rs](https://github.com/hyprland-community/hyprland-rs) - An unofficial rust wrapper for hyprland's IPC \[maintainers=@yavko]

*   [ChenXu233/YaoXiang](https://github.com/ChenXu233/YaoXiang) - YaoXiang（爻象）—— 实验性通用编程语言，设计理念源于《易经》中「爻」与「象」的核心概念。Type-as-everything。

*   [theMackabu/loft](https://github.com/theMackabu/loft) - Rusty embedded scripting language
...
*   [xxvw/Conduction](https://github.com/xxvw/Conduction) - Blueprint based conduction style dj software

*   [codedeliveryservice/Reckless](https://github.com/codedeliveryservice/Reckless) - Competitive chess engine written in Rust

*   [abdullah-albanna/rusbmux](https://github.com/abdullah-albanna/rusbmux) - A usbmuxd replacement in pure Rust
...
*   [tayenx3/miel](https://github.com/tayenx3/miel) - A cozy, general-purpose programming language for creating provably safe and secure systems
...
*   [rust-random/rngs](https://github.com/rust-random/rngs) - Extra RNGs

*   [khonsulabs/cityhasher](https://github.com/khonsulabs/cityhasher) -
...
*   [yexiyue/ratatui-kit](https://github.com/yexiyue/ratatui-kit) - Build component-driven terminal UIs in Rust with React-style components, hooks, props, routing, input layers, and global state. Powered by Ratatui and Tokio.

*   [os-tack/osteak](https://github.com/os-tack/osteak) - Elm for ratatui — you bring the loop

*   [dmk/tui-dispatch](https://github.com/dmk/tui-dispatch) -

*   [wingertge/sycamore-query](https://github.com/wingertge/sycamore-query) -

*   [ratatui/tui-widgets](https://github.com/ratatui/tui-widgets) - A collection of useful widgets for building terminal user interfaces using Ratatui

*   [jharsono/tui-overlay](https://github.com/jharsono/tui-overlay) - A composable overlay widget for Ratatui with drawers, modals, popovers, and toasts from a single configurable primitive.
...
*   [neneodonkor/asciigraph-rs](https://github.com/neneodonkor/asciigraph-rs) - Rust Library to make lightweight ASCII line graph ╭┈╯ in command line apps.
...
*   [jamescarterbell/mafia\_server](https://github.com/jamescarterbell/mafia_server) - Mafia server for class project

*   [onurkun/RustAegis](https://github.com/onurkun/RustAegis) - Advanced Rust code virtualization and obfuscation framework

*   [ISibboI/secure-string](https://github.com/ISibboI/secure-string) - Rust crate for secure handling of sensitive data.

*   [calder/rust-mafia](https://github.com/calder/rust-mafia) - Rust implementation of the classic party game Mafia

*   [slawlor/ractor](https://github.com/slawlor/ractor) - Rust actor framework

*   [lambdaclass/spawned](https://github.com/lambdaclass/spawned) - A Rust library for decoupling concurrency from application logic, following the model used by Erlang and the BEAM VM
...
*   [krcpa/service-builder](https://github.com/krcpa/service-builder) - A lightweight, type-safe service construction pattern for Rust applications that leverages the builder pattern.
...
*   [uwejan/tokio-actors](https://github.com/uwejan/tokio-actors) - Zero-ceremony, Tokio-native actors with strong typing and production-ready edge case handling, perfect for AI/LLM Applications.

*   [spencerjibz/typed-emitter](https://github.com/spencerjibz/typed-emitter) - A simple and concurrent event-emitter
...
*   [Hydle-Research-Group/yourgpu](https://github.com/Hydle-Research-Group/yourgpu) - A modern, simple, and fast graphics API for Rust.
...
*   [c410-f3r/wtx](https://github.com/c410-f3r/wtx) - Written by humans. WTX is a collection of different transport implementations and related tools focused primarily on web technologies.
...
*   [Yahddyyp/MacOS-Dotfiles](https://github.com/Yahddyyp/MacOS-Dotfiles) - Just some dotfiles I use while using MacOS

*   [miskcoo/ugreen\_leds\_controller](https://github.com/miskcoo/ugreen_leds_controller) - An LED Controller for UGREEN's DX/DXP NAS Series
...
*   [yeyushengfan258/WinSur-dark-cursors](https://github.com/yeyushengfan258/WinSur-dark-cursors) - WinSur cursors for linux desktops

*   [ful1e5/BreezeX\_Cursor](https://github.com/ful1e5/BreezeX_Cursor) - extended KDE cursor.
...
*   [Accademia/Additional\_Rule\_For\_Clash](https://github.com/Accademia/Additional_Rule_For_Clash) - 🔴 🟡 🟢 Clash 分流规则  🟢 🟡 🔴 ，作为 blackmatrix7/ios\_rule\_script的补充规则。（Clash Routing Rules as a Supplement to blackmatrix7/ios\_rule\_script）

*   [RayLee1997/Shared-Workspace](https://github.com/RayLee1997/Shared-Workspace) - Obsidian & AI Agent Workspace
...
*   [ip2location/IP2Location-C-Library](https://github.com/ip2location/IP2Location-C-Library) - IP2Location C library enables the user to find the country, region, city, coordinates, zip code, time zone, ISP, domain name, connection type, area code, weather station code, weather station name, mobile, usage types, etc that any IP address or hostname originates from.
...
*   [anmoti/dotfiles](https://github.com/anmoti/dotfiles) - My dotfiles.
...
*   [ChaonicTheDeathKitten/Palette-Helper](https://github.com/ChaonicTheDeathKitten/Palette-Helper) -

*   [Li2CO3ICU/Li2CO3VIM](https://github.com/Li2CO3ICU/Li2CO3VIM) -

*   [SpecIR/SpecCompiler](https://github.com/SpecIR/SpecCompiler) - A relational intermediate representation (IR) and extensible type system for Markdown specifications.
...
*   [tsktp/The-Cough](https://github.com/tsktp/The-Cough) -
...
*   [Gakuto1112/FiguraBlueArchiveCrafters](https://github.com/Gakuto1112/FiguraBlueArchiveCrafters) - The avatars for Figura, the skin mod for Minecraft Java Edition, which are imitated characters who appear in "Blue Archive (ブルーアーカイブ)", the game for mobile devices.
...
*   [0x78654C/xTerminal](https://github.com/0x78654C/xTerminal) - A linux like terminal for windows in C#
...
*   [drpetersonfernandes/SimpleZipDrive](https://github.com/drpetersonfernandes/SimpleZipDrive) - Simple Zip Drive is a high-performance, user-mode filesystem utility that allows you to mount ZIP, 7Z, and RAR archives as virtual drives or NTFS directory mount points. It provides seamless, read-only access to compressed data without the need for manual extraction.

*   [desu-life/Bot](https://github.com/desu-life/Bot) -

*   [LuoTianOrange/STS2\_WineFox](https://github.com/LuoTianOrange/STS2_WineFox) - A SlayTheSpire2 WineFox Mod base on RitsuLib | 杀戮尖塔2 酒狐模组
...
*   [ammgws/wshowkeys](https://github.com/ammgws/wshowkeys) -
...
*   [tinygrad/asm2464pd-firmware](https://github.com/tinygrad/asm2464pd-firmware) - Firmware for the ASM2464PD
...
*   [Unclecheng-li/poc-lab](https://github.com/Unclecheng-li/poc-lab) - Recent CVE PoC & reproduction scripts. Focused on high-severity vulnerabilities across Linux kernel, Windows, macOS and more.
...
*   [tsoding/la](https://github.com/tsoding/la) - Linear Algebra in C for 2D/3D Computer Graphics

*   [Delphos-Labs/disclosures](https://github.com/Delphos-Labs/disclosures) - Vulnerability disclosures and proof-of-concept exploits

*   [zephyrproject-rtos/zephyr](https://github.com/zephyrproject-rtos/zephyr) - Primary Git Repository for the Zephyr Project. Zephyr is a new generation, scalable, optimized, secure RTOS for multiple hardware architectures.

*   [u-boot/u-boot](https://github.com/u-boot/u-boot) - "Das U-Boot" Source Tree

*   [libyal/libfsrefs](https://github.com/libyal/libfsrefs) - Library and tools to access the Resilient File System (ReFS)
...
*   [oov/aviutl2\_psdtoolkit2](https://github.com/oov/aviutl2_psdtoolkit2) - PSDToolKit for AviUtl ExEdit2
...
*   [xypwn/bad-apple-stereogram](https://github.com/xypwn/bad-apple-stereogram) -
...
*   [catseye/Befunge-93](https://github.com/catseye/Befunge-93) - MIRROR of https://codeberg.org/catseye/Befunge-93 : The NEW reference distribution for Befunge-93!
...
*   [ViudiraTech/Uinxed-Kernel](https://github.com/ViudiraTech/Uinxed-Kernel) - Uinxed is a unix-like x64 kernel developed from scratch. Aims to build an perfect kernel.
...
*   [maandree/sha3sum](https://github.com/maandree/sha3sum) - SHA-3 and Keccak checksum utility
...
*   [scenery-io/stallion](https://github.com/scenery-io/stallion) - Scripting bridge for Cavalry
...
*   [HSPK/mm](https://github.com/HSPK/mm) - Lite Media Manager

*   [DanteAlighieri13210914/pv-tool](https://github.com/DanteAlighieri13210914/pv-tool) - Automaticly generate kinetic typography
...
*   [epheiamoe/bsky](https://github.com/epheiamoe/bsky) - A dual-UI (TUI + PWA) Bluesky client with deep AI integration. Built with TypeScript, Ink (React), React DOM, and AT Protocol.

*   [fabriziosalmi/mixi](https://github.com/fabriziosalmi/mixi) - Deterministic audio workstation. Browser-native. Zero install. Dual decks, Rust/Wasm DSP, WebGPU visuals, 19 instruments, automixer, beatmatching, 17 skins, MIDI, headphone cue.
...
*   [jonaspm/bunwright](https://github.com/jonaspm/bunwright) - The lightweight browser automation library for Bun

*   [cainhooow/rustautomod](https://github.com/cainhooow/rustautomod) - Rust Automod is a Visual Studio Code extension that keeps Rust module files in sync for you. It creates and updates mod.rs, lib.rs, and main.rs module declarations automatically, supports both the classic folder/mod.rs layout and the modern folder.rs + folder/ layout, supports richer .rautomod project rules, adds syntax highlighting and formatting.

*   [ryohsuke1231/liquid-glass](https://github.com/ryohsuke1231/liquid-glass) - Gnome Shell Extension of Liquid Glass
...
*   [SkeldJS/Waterway](https://github.com/SkeldJS/Waterway) - A scalable Among Us server written in typescript and made using SkeldJS.

*   [skeld-net/Hindenburg](https://github.com/skeld-net/Hindenburg) - A scalable Among Us server written in typescript and made using SkeldJS.
...
*   [CyberStrikeus/CyberStrike](https://github.com/CyberStrikeus/CyberStrike) - AI-powered offensive security agent with 7,300+ actionable security skills. Autonomous pentesting powered by MITRE ATT\&CK (2,000+ Atomic tests), CIS Benchmarks (1,500+ controls), OWASP, NIST. Lazy-loading, zero context pollution. Your AI red team.

*   [langgenius/mosoo-agent-driver](https://github.com/langgenius/mosoo-agent-driver) - Runtime-neutral driver for Claude Code, Codex, and ACP. Compatible with Claude Managed Agents (CMA) API.
...
*   [acnekot/NekoCircle](https://github.com/acnekot/NekoCircle) - 一个基于twitterapi或者yahoo的推特圈生成器

*   [pingdotgg/t3code](https://github.com/pingdotgg/t3code) -

*   [valehasadli/BlinkHub](https://github.com/valehasadli/BlinkHub) - 🌟 Blinkhub: A Robust TypeScript Event Emitter. This library provides a type-safe interface for seamless event subscription and emission. Built with TypeScript, it facilitates efficient and scalable event-driven patterns in applications.

*   [connectrpc/validate-es](https://github.com/connectrpc/validate-es) - Flexible, efficient request validation for Connect.

*   [marianmeres/actor](https://github.com/marianmeres/actor) - A lightweight, type-safe Single Actor Model implementation
...
*   [JohnnyZ93/oai-compatible-copilot](https://github.com/JohnnyZ93/oai-compatible-copilot) - A VSCode extension to use Openai/Ollama/Anthropic/Gemini API Providers in GitHub Copilot Chat

*   [philihp/openskill.js](https://github.com/philihp/openskill.js) - A faster, open-license alternative to Microsoft TrueSkill
...
*   [Maokus/MVMNT](https://github.com/Maokus/MVMNT) - Free, Open Source MIDI Visualization

*   [sparrowhe/bluesky-circle](https://github.com/sparrowhe/bluesky-circle) - Bluesky Circle like Twitter Circle

*   [modelcontextprotocol/servers](https://github.com/modelcontextprotocol/servers) - Model Context Protocol Servers

*   [xiaolaa2/ableton-copilot-mcp](https://github.com/xiaolaa2/ableton-copilot-mcp) - An MCP server built on ableton-js enables AI assistants to control Ableton Live in real time, including Arrangement View operations such as song management, track control, MIDI editing, and audio recording, along with other capabilities.
...
*   [HappyOnigiri/PixelRefiner](https://github.com/HappyOnigiri/PixelRefiner) - Clean up AI-generated pixel art into production-ready sprites. Removes anti-aliasing, detects grids, converts palettes, and optimizes transparency—all in your browser.

*   [univeous/Pixel-Extractor](https://github.com/univeous/Pixel-Extractor) - Web-based tool to extract pixel art sprites from AI-generated images — automatic grid detection, color quantization, works offline as PWA

*   [statelyai/xstate](https://github.com/statelyai/xstate) - State machines, statecharts, and actors for complex logic

*   [JimLiu/baoyu-skills](https://github.com/JimLiu/baoyu-skills) -

*   [dylanebert/VibeGame](https://github.com/dylanebert/VibeGame) - A 3D game engine designed for vibe coding
...
*   [roxcom-br/modustry](https://github.com/roxcom-br/modustry) - O Modustry é a plataforma responsável por centralizar, organizar e disponibilizar mods para o jogo Mindustry de forma prática, intuitiva e eficiente.

*   [KatouRyuuji/TagLauncher](https://github.com/KatouRyuuji/TagLauncher) - A Tauri + React desktop tag launcher

*   [edxeth/Shai-Hulud-Open-Source](https://github.com/edxeth/Shai-Hulud-Open-Source) -
...
*   [BackGwa/Redstone](https://github.com/BackGwa/Redstone) - Redstone : an Opencode agent that simplifies Minecraft plugin development and deployment.
...
*   [aternosorg/mc-server-management](https://github.com/aternosorg/mc-server-management) - A library for the Minecraft server management protocol added in 25w35a

*   [open-rpc/spec](https://github.com/open-rpc/spec) - The OpenRPC specification

*   [Ouonnki/OuonnkiTV](https://github.com/Ouonnki/OuonnkiTV) - Ouonnki TV —— 一键搭建个人影视站，支持Vercel自动部署，基于LibreTV修改

*   [NixOS-CN/nixos-cn.github.io](https://github.com/NixOS-CN/nixos-cn.github.io) - NixOS 中文社区官网

*   [amarsbar/rice-cooker](https://github.com/amarsbar/rice-cooker) - a visual (toy) tool for ricing

*   [getwud/wud](https://github.com/getwud/wud) - Keep your containers up-to-date!

*   [TankFactory/Mirage\_Decode](https://github.com/TankFactory/Mirage_Decode) - 光棱坦克工厂
...
*   [Kilo-Org/kilocode-legacy](https://github.com/Kilo-Org/kilocode-legacy) - Kilo is the all-in-one agentic engineering platform. Build, ship, and iterate faster with the most popular open source coding agent.
...
*   [lunafromthemoon/RenJS-V2](https://github.com/lunafromthemoon/RenJS-V2) - RenJS Typescript Version

*   [DGCK81LNN/xdi8-transcriber](https://github.com/DGCK81LNN/xdi8-transcriber) - 〇改希顶语转写器 Shidinn-Hanzi transcriber
...
*   [YunYouJun/advjs](https://github.com/YunYouJun/advjs) - 🎮 ADV.JS Web AVG Engine 面向未来与前端的文字冒险游戏引擎（WIP）

*   [VOICEVOX/voicevox](https://github.com/VOICEVOX/voicevox) - 無料で使える中品質なテキスト読み上げソフトウェア、VOICEVOXのエディター

*   [phishinqi/MIDI-Navigate](https://github.com/phishinqi/MIDI-Navigate) - 一个简单易用MIDI可视化

*   [Neosku/aviutl2-catalog](https://github.com/Neosku/aviutl2-catalog) - AviUtl2 のプラグインやスクリプトを、検索・インストール・アップデートまで一括管理できる デスクトップ向けカタログアプリです。

*   [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) - The API to search, scrape, and interact with the web at scale. 🔥

*   [asbedb/Scapedle](https://github.com/asbedb/Scapedle) - An OSRS inspired wordle game

*   [landakram/remark-wiki-link](https://github.com/landakram/remark-wiki-link) - Parse and render wiki links.

*   [CipherwillHQ/Cipherwill](https://github.com/CipherwillHQ/Cipherwill) - With Cipherwill - Your data reaches your loved ones when you pass away. Open Source Cipherwill Web Client.
...
*   [BCsabaEngine/svelteesp32](https://github.com/BCsabaEngine/svelteesp32) - Pack any Svelte, React, Angular, or Vue app into a single C++ header. Serve it straight from ESP32/ESP8266 flash — gzip compressed, ETag cached, OTA-ready.

*   [HkTeamX/node-napcat-ts](https://github.com/HkTeamX/node-napcat-ts) - napcat SDK

*   [NapLink/NapLink](https://github.com/NapLink/NapLink) - TypeScript OneBot v11 协议 SDK，专为 NapCat 设计 - 类型安全、现代化、开发者友好

*   [elysiajs/elysia-static](https://github.com/elysiajs/elysia-static) - Plugin for Elysia for serving static folder
...
*   [inpageedit/inpageedit-next](https://github.com/inpageedit/inpageedit-next) - 🚀 Modular, Extensible Supercharged Plugin for MediaWiki
...
*   [logonoff/obsidian-inline-spoilers](https://github.com/logonoff/obsidian-inline-spoilers) - Adds Discord-like syntax for inline spoilers.

*   [Jannchie/zeroroku](https://github.com/Jannchie/zeroroku) -

*   [mermaid-js/mermaid](https://github.com/mermaid-js/mermaid) - Generation of diagrams like flowcharts or sequence diagrams from text in a similar manner as markdown

*   [TypeCellOS/BlockNote](https://github.com/TypeCellOS/BlockNote) - A React Rich Text Editor that's block-based (Notion style) and extensible. Built on top of Prosemirror and Tiptap.

*   [merlinfuchs/embed-generator](https://github.com/merlinfuchs/embed-generator) - Create rich embed messages for Discord (previously discord.club)
...
*   [afonsojramos/slidev-decks](https://github.com/afonsojramos/slidev-decks) - CLI companion for managing multiple Slidev presentations
...
*   [misskey-dev/mfm.js](https://github.com/misskey-dev/mfm.js) - An MFM parser implementation with TypeScript.
...
*   [nicola02nb/completeDiscordQuest](https://github.com/nicola02nb/completeDiscordQuest) - A Vencord plugin that completes you multiple discord quests in background simultaneously

*   [Talya1412/completeDiscordQuest](https://github.com/Talya1412/completeDiscordQuest) - A Vencord plugin that completes you multiple discord quests in background simultaneously

*   [QingJ01/CodeDiary](https://github.com/QingJ01/CodeDiary) - 一个专注于“编码量统计”的 VS Code 插件

*   [WintrCat/wintrchess](https://github.com/WintrCat/wintrchess) - WintrChess ♟️
...
*   [may-today/mayday.blue](https://github.com/may-today/mayday.blue) - Mayday lyrics collection webapp.

*   [justplainstuff/plainjob](https://github.com/justplainstuff/plainjob) - SQLite-backed job queue processing 15k jobs/s

*   [jails-org/Jails](https://github.com/jails-org/Jails) - Elegant and Minimalistic Web Components Micro Framework

*   [yusixian/moe-copy-ai](https://github.com/yusixian/moe-copy-ai) - ✨ 萌萌哒的 AI 网页数据提取助手 ✨

*   [maebahesioru/nareaitter](https://github.com/maebahesioru/nareaitter) -
...
*   [DemoMacro/docen](https://github.com/DemoMacro/docen) - Universal document format converter providing seamless transformation between Markdown, HTML, and DOCX formats. Built on TipTap/ProseMirror with comprehensive TypeScript support.
...
*   [grammyjs/parse-mode](https://github.com/grammyjs/parse-mode) - Safely format messages and keep their source code maintainable.
...
*   [Amoyens1s/markdown-to-mfuns-json](https://github.com/Amoyens1s/markdown-to-mfuns-json) - 把Markdown格式的内容转换成喵御宅定制化的QuillJson
...
*   [PocketTogether/pocket-chat](https://github.com/PocketTogether/pocket-chat) - 一个基于 PocketBase 与 Vue3 的实时聊天平台 | A real-time chat platform built with PocketBase and Vue3.

*   [Tweblog/tweblog](https://github.com/Tweblog/tweblog) - 一个社交媒体博客化工具，针对推特等平台的内容进行导入与转发。拥有支持 Windows 的桌面版，和使用 Docker 部署的Web版。

*   [aiscript-dev/aiscript](https://github.com/aiscript-dev/aiscript) - 🔋 A lightweight scripting language runing on JavaScript
...
*   [KTibow/m3-svelte](https://github.com/KTibow/m3-svelte) - The Material 3 design system in Svelte, cleanly, robustly, and across disciplines.
...
*   [p-toy-factory/sakana-widget-react](https://github.com/p-toy-factory/sakana-widget-react) - A React component that wrap "Sakana! Widget".
...
*   [karakeep-app/liteque](https://github.com/karakeep-app/liteque) - A SQLite based job queue implementation in typescript
...
*   [jsimonrichard/ProseMark](https://github.com/jsimonrichard/ProseMark) - A toolkit for building open-source "What you see is what you mean" markdown editors, like Obsidian or Typora
...
*   [volser/md-to-quill-delta](https://github.com/volser/md-to-quill-delta) -

*   [denoland/denokv](https://github.com/denoland/denokv) - A self-hosted backend for Deno KV

*   [jalavosus/sveltelegos-blue](https://github.com/jalavosus/sveltelegos-blue) - A framework for Svelte Utilities 💡 Current status: 87 utilities.

*   [svelte-librarian/sv-use](https://github.com/svelte-librarian/sv-use) - \[UNMAINTAINED] A collection of Svelte 5 utilities.

*   [zerebos/ghostty-config](https://github.com/zerebos/ghostty-config) - A beautiful config generator for Ghostty terminal.

*   [ajkdrag/otterly](https://github.com/ajkdrag/otterly) - A local-first, privacy-focused WYSIWYG Markdown vault with full-text search, wiki-links, and a rich editor. Built with Tauri, Svelte, and Rust.

*   [stormyzio/deltaray](https://github.com/stormyzio/deltaray) - DeltaRay - an optic physics simulation

*   [tomjs/vite-plugin-vscode](https://github.com/tomjs/vite-plugin-vscode) - 用 vue/react 来开发 vscode extension webview ，支持 esm 和 cjs。Use vue/react to develop vscode extension webview, supporting esm and cjs.

*   [antfu/starter-vscode](https://github.com/antfu/starter-vscode) - Starter template for VS Code Extension

*   [surrealdb/surrealql-vsx](https://github.com/surrealdb/surrealql-vsx) - SurrealQL grammar definition for TextMate, VSCode, and other IDEs

*   [ieedan/bizi](https://github.com/ieedan/bizi) - Manage dependent concurrent tasks.
...
*   [thisuxhq/sveltednd](https://github.com/thisuxhq/sveltednd) - A lightweight, flexible drag and drop library for Svelte 5 applications.

*   [jeromeludmann/irc](https://github.com/jeromeludmann/irc) - IRC client protocol module for Deno, Node.js and Bun
...
*   [xuanli199/weekly](https://github.com/xuanli199/weekly) - 保存玄离199每周科技补全中提到的各种软件和项目
...
*   [achromaticlabs/shadcn-modal-manager](https://github.com/achromaticlabs/shadcn-modal-manager) - Lightweight React modal manager with promise-based API. Supports Shadcn UI, Radix UI and Base UI.

*   [humanspeak/svelte-motion](https://github.com/humanspeak/svelte-motion) - Framer Motion for Svelte 5. Declarative motion.\<tag> components with AnimatePresence exit animations, gestures (hover, tap, drag, focus, in-view), variants, FLIP layout animations, shared-layout transitions, spring physics, and scroll-linked motion values. The drop-in Framer Motion alternative for Svelte and SvelteKit.

*   [solidjs/solid](https://github.com/solidjs/solid) - A declarative, efficient, and flexible JavaScript library for building user interfaces.

*   [tiajinsha/JKVideo](https://github.com/tiajinsha/JKVideo) - 高颜值第三方 B 站 React Native 客户端

*   [tiesen243/yuki-ui](https://github.com/tiesen243/yuki-ui) - A modern UI component library for React built on top of shadcn/ui. Beautiful, accessible, and customizable components for your next project.

*   [fuma-nama/fumadocs](https://github.com/fuma-nama/fumadocs) - The beautiful & flexible React.js docs framework.

*   [mateothegreat/svelte5-router](https://github.com/mateothegreat/svelte5-router) - 🫦 An SPA router for Svelte that allows you to divide & conquer your app with nested routers, snippets, and more.
...
*   [sandros94/nuxt-surrealdb](https://github.com/sandros94/nuxt-surrealdb) - A Nuxt module aimed to simplify the use of SurrealDB.
...
*   [ForetagInc/tanstack-db-surrealdb](https://github.com/ForetagInc/tanstack-db-surrealdb) - Opinionated SurrealDB collections for Tanstack DB for Local First apps with CRDTs

*   [Oneiriq/surql](https://github.com/Oneiriq/surql) - A code-first database toolkit for SurrealDB

*   [idkhurry/Aura\_AGI](https://github.com/idkhurry/Aura_AGI) - 🧠 Experience genuine learning and emotional interaction with Aura, your local AGI companion that evolves alongside you.

*   [ahmedali5530/pos-frontend](https://github.com/ahmedali5530/pos-frontend) - Point of sale system (POS) written in React and SurrealDB

*   [grafana-cold-storage/surrealdb-datasource](https://github.com/grafana-cold-storage/surrealdb-datasource) - A datasource plugin for SurrealDB

*   [DTMWiki/IdeaSaver](https://github.com/DTMWiki/IdeaSaver) - DTMWiki File Hosting & Delivery Services
...
*   [Blushyes/flowmark](https://github.com/Blushyes/flowmark) - 收藏时由 AI 自动帮你整理书签。
...
*   [oskar-gmerek/surreal-better-auth](https://github.com/oskar-gmerek/surreal-better-auth) - SurrealDB Adapter for Better Auth. Use your favorite database as a Better-Auth storage.

*   [sebastianwessel/surrealdb-client-generator](https://github.com/sebastianwessel/surrealdb-client-generator) - Tool which generates a typescript client for SurrealDB and zod schema of a given database
...
*   [UNIkeEN/SJMCL](https://github.com/UNIkeEN/SJMCL) - 🌟 A Minecraft launcher born from @SJMC-Dev, built with the community
...
*   [denny-il/drizzle-pg-utils](https://github.com/denny-il/drizzle-pg-utils) - Collection of helpful utilities to work with Drizzle and PostgreSQL

*   [Norbiros/nuxt-auto-form](https://github.com/Norbiros/nuxt-auto-form) - 🧾 Auto-generate Nuxt UI forms from Zod 4 schemas

*   [tkesgar/nuxt-elysia](https://github.com/tkesgar/nuxt-elysia) - Mount Elysia app in Nuxt
...
*   [hexadecimal233/bytebeat-ts](https://github.com/hexadecimal233/bytebeat-ts) - \* creating music with typescript \*
...
*   [piellardj/stereogram-solver](https://github.com/piellardj/stereogram-solver) - Stereogram (aka Magic Eye) solver, for people who can't see them .

*   [TNXG/tnxg-homepage](https://github.com/TNXG/tnxg-homepage) - TiaNXianG's Homepage
...
*   [ozhanefemeral/bun-vs-node](https://github.com/ozhanefemeral/bun-vs-node) - Code repository to benchmark and compare Node.js vs Bun. results:
...
*   [elcharitas/elysia-atlas](https://github.com/elcharitas/elysia-atlas) - Advanced file-system router for ElysiaJS featuring automatic type generation and strict type inference

*   [web-infra-dev/modern.js](https://github.com/web-infra-dev/modern.js) - A progressive web framework based on React and Rsbuild.

*   [hexadecimal233/elysia-body-limit](https://github.com/hexadecimal233/elysia-body-limit) - A lightweight body size limit plugin for Elysia.
...
*   [elysiajs/arona](https://github.com/elysiajs/arona) - Elysia AI doc search
...
*   [bruce48x/kcpjs](https://github.com/bruce48x/kcpjs) - js version of kcp
...
*   [Lqm1/x-client-transaction-id](https://github.com/Lqm1/x-client-transaction-id) - Client Transaction ID generator library for X (formerly Twitter) API requests
...
*   [bth95147/bth95147.github.io](https://github.com/bth95147/bth95147.github.io) -
...
*   [Twisuki/blog](https://github.com/Twisuki/blog) - Twisuki's Blog, Powered by Vuepress-theme-hope.
...
*   [creatorsgarten/creatorsgarten.org](https://github.com/creatorsgarten/creatorsgarten.org) - Creatorsgarten = Garden of Creators
...
*   [amplitudesxd/discord-k-id-verifier](https://github.com/amplitudesxd/discord-k-id-verifier) - stop intrusive access to your personal data due to the uk's online safety act
...
*   [apiture/openapi-down-convert](https://github.com/apiture/openapi-down-convert) - Convert an OpenAPI 3.1.x document to OpenAPI 3.0.x format
...
*   [elysiajs/elysia-openapi](https://github.com/elysiajs/elysia-openapi) - A plugin for Elysia to auto-generate Swagger page
...
*   [leaferjs/leafer](https://github.com/leaferjs/leafer) - 好用的 Canvas 引擎，leafer 是核心代码库，leafer-ui 是入口仓库(stars 3.9k)。
...
*   [KatsuteDev/Background](https://github.com/KatsuteDev/Background) - The most advanced background image extension for VSCode

*   [EveSunMaple/SaroProck](https://github.com/EveSunMaple/SaroProck) - 我的个人博客！使用 Astro + React

*   [a-skua/core.js](https://github.com/a-skua/core.js) - My favorite types.
...
*   [qxchuckle/vsc-drafts](https://github.com/qxchuckle/vsc-drafts) - VSCode插件-草稿本，方便管理代码草稿和临时文件，再也不用多打开一个窗口了

*   [continuedev/continue](https://github.com/continuedev/continue) - open-source coding agent

*   [danm/image-hash](https://github.com/danm/image-hash) - Create a hash from an image

*   [raphaelDkhn/GitDaw](https://github.com/raphaelDkhn/GitDaw) - Leverage the power of Git to collaborate seamlessly on your Ableton projects.
...
*   [praha-inc/byethrow](https://github.com/praha-inc/byethrow) - A lightweight, tree-shakable Result type package with a simple, consistent API designed.

*   [zxch3n/throwable](https://github.com/zxch3n/throwable) - A type-safe way to work with error (Haskell's Either | Rust's Result)

*   [docmost/docmost](https://github.com/docmost/docmost) - Docmost is an open-source collaborative wiki and documentation software. It is an open-source alternative to Confluence and Notion.

*   [Effect-TS/effect](https://github.com/Effect-TS/effect) - Build production-ready applications in TypeScript

*   [pwlmc/imghash](https://github.com/pwlmc/imghash) - Perceptual image hashing for Node.js
...
*   [yang-zhongtian/KProtect](https://github.com/yang-zhongtian/KProtect) - Stack-based JavaScript virtual machine

*   [qxchuckle/vsc-cec-ide](https://github.com/qxchuckle/vsc-cec-ide) - 一个没什么用的VSC插件

*   [getkey/rollup-plugin-obfuscator](https://github.com/getkey/rollup-plugin-obfuscator) - The most powerful rollup plugin for javascript-obfuscator.
...
*   [XiaMi-Long/VS-Code-EasyAnimCode](https://github.com/XiaMi-Long/VS-Code-EasyAnimCode) - 对vscode操作进行添加简单动画的插件

*   [antfu/vscode-icons-carbon](https://github.com/antfu/vscode-icons-carbon) - Carbon Visual Studio Code product icon theme
...
*   [shield-labs/zklogin](https://github.com/shield-labs/zklogin) - Sign in with Apple/Google on any EVM chain. Self-custodial.

*   [NowaraJS/elysia-cache](https://github.com/NowaraJS/elysia-cache) - You can find this package, which is maintained by DWS (The cache plugin will be restored soon)

*   [woodfishhhh/Woodfish-Theme](https://github.com/woodfishhhh/Woodfish-Theme) - 一个优雅的 VSCode 渐变主题，提供现代化的视觉体验和舒适的编程环境。
...
*   [subframe7536/vscode-custom-ui-style](https://github.com/subframe7536/vscode-custom-ui-style) - VSCode extension that modify CSS and JS code in both editor and webview, unify global font family, setup background image and Electron BrowserWindow options, add your custom CSS or JS code, and even patch files in other VSCode extensions.

*   [zkemail/proof-of-twitter](https://github.com/zkemail/proof-of-twitter) - Use https://twitter.prove.email to prove that you own a Twitter username, on-chain.

*   [zkemail/zk-email-verify](https://github.com/zkemail/zk-email-verify) - Verify any text in any sent or received email, cryptographically and via only trusting the sending mailserver.

*   [cloudflare/moltworker](https://github.com/cloudflare/moltworker) - Run OpenClaw, (formerly Moltbot, formerly Clawdbot) on Cloudflare Workers

*   [EnixCoda/Gitako](https://github.com/EnixCoda/Gitako) - 🐙 File tree extension for GitHub on Chrome & Firefox & Edge

*   [FireStreaker2/FemboyFinder](https://github.com/FireStreaker2/FemboyFinder) - Simple image querier using express and gelbooru
...
*   [janosh/matterviz](https://github.com/janosh/matterviz) - Interactive browser visualizations for materials science: crystal structures/molecules, trajectories, convex hulls, phase diagrams, Fermi surfaces, bands+DOS, Brillouin zones, etc.
...
*   [TransparentLC/qsticker](https://github.com/TransparentLC/qsticker) - QQ 表情商城/Bilibili 收藏集表情包下载站
...
*   [realies/soundcloud-sync](https://github.com/realies/soundcloud-sync) - ☁️ SoundCloud likes to local files

*   [ArthurTent/ShaderAmp](https://github.com/ArthurTent/ShaderAmp) - Chrome and Firefox extension to visualize music
...
*   [Khaomi/discord-rpc](https://github.com/Khaomi/discord-rpc) - a fork of discordjs/RPC
...
*   [Moebytes/Kisaragi](https://github.com/Moebytes/Kisaragi) - A kawaii discord bot!
...
*   [GeKaixing/GK](https://github.com/GeKaixing/GK) - Copy Twitter/X
...
*   [amll-dev/applemusic-like-lyrics](https://github.com/amll-dev/applemusic-like-lyrics) - An Apple Music style lyric player component, with React & Vue support. 一个类 Apple Music 歌词显示组件，同时提供 React 和 Vue 绑定。
...
*   [otomad/OtomadHelper](https://github.com/otomad/OtomadHelper) - Scripts to assist in creating YTPMV/YTP/otoMAD/音MAD in Vegas Pro
...
*   [Migushthe2nd/MsEdgeTTS](https://github.com/Migushthe2nd/MsEdgeTTS) - A simple Azure Speech Service module that uses the Microsoft Edge Read Aloud API. https://www.npmjs.com/package/msedge-tts
...
*   [danielsimonjr/everything-mcp](https://github.com/danielsimonjr/everything-mcp) - MCP server for Everything search engine - instant file search for Windows

*   [ganeshrvel/openmtp](https://github.com/ganeshrvel/openmtp) - OpenMTP  - Advanced Android File Transfer Application for macOS

*   [rrenoir/cavalry-mcp-272](https://github.com/rrenoir/cavalry-mcp-272) - Patched version of Cavalry-MCP for:  - Cavalry 2.7.2 - Stallion - Claude Desktop / Claude Cowork - Node.js >=18

*   [kacperchlebowicz/Cavalry-mcp](https://github.com/kacperchlebowicz/Cavalry-mcp) -

*   [itsyaasir/rust-feature-toggler](https://github.com/itsyaasir/rust-feature-toggler) - VS Code Extension for quick enabling and disabling rust feature

*   [leebyron/dotfiles](https://github.com/leebyron/dotfiles) -

*   [Tech-Tac/aosp-cursors](https://github.com/Tech-Tac/aosp-cursors) - Android cursors for Linux & Windows

*   [r58Playz/uBlock-mv3](https://github.com/r58Playz/uBlock-mv3) - Full MV3 port of uBlock Origin - An efficient blocker for Chromium and Firefox. Fast and lean.

*   [GreyWolfDev/Werewolf](https://github.com/GreyWolfDev/Werewolf) - Werewolf for Telegram

*   [yuna0x0/svelte-neko](https://github.com/yuna0x0/svelte-neko) - A Svelte 5 port of the Oneko.js library

*   [cb1kenobi/hook-emitter](https://github.com/cb1kenobi/hook-emitter) - Event emitter with support for asynchronous handlers and a sweet function hook mechanism.
...
*   [EtherDream/hash-miner](https://github.com/EtherDream/hash-miner) - A SHA-256 PoW demo implemented with WebGPU and Wasm SIMD

*   [immerjs/immer](https://github.com/immerjs/immer) - Create the next immutable state by mutating the current one

*   [stemdeckapp/stemdeck](https://github.com/stemdeckapp/stemdeck) - Stemdeck is an modern stem extraction platform for musicians,producers and hobbyists, designed to isolate vocals, drums, bass, piano and guitar  for practice, transcription, remixing, and creative audio workflows through a modern and interactive interface
...
*   [32comic/image2pixel-web](https://github.com/32comic/image2pixel-web) - A simple web-based tool that converts images into pixel art style.
...
*   [daftAI2026/Cavalry-i18n](https://github.com/daftAI2026/Cavalry-i18n) - Switch Cavalry between English, 简体中文, 繁體中文, and 日本語 — one-click language patcher for macOS.

*   [wentam/unified-inhibit](https://github.com/wentam/unified-inhibit) - Make wakelocks actually work

*   [vkohaupt/vokoscreenNG](https://github.com/vkohaupt/vokoscreenNG) - vokoscreenNG is a powerful screencast creator in many languages to record the screen, an area or a window (Linux only). Recording of audio from multiple sources is supported. With the built-in camera support, you can make your video more personal. Other tools such as systray, magnifying glass, countdown, timer, Showclick and Halo support will help
...
*   [sandwichfarm/hyprexpo](https://github.com/sandwichfarm/hyprexpo) - The original hyprexpo fork

*   [CapsAdmin/hyprdecor](https://github.com/CapsAdmin/hyprdecor) - advanced window decorations for hyprland

*   [hyprwm/hyprtoolkit](https://github.com/hyprwm/hyprtoolkit) - A modern C++ Wayland-native GUI toolkit

*   [gen3vra/hyprwinwrap](https://github.com/gen3vra/hyprwinwrap) - Display any window as a wallpaper in Hyprland
...
*   [gfhdhytghd/HyprCapture](https://github.com/gfhdhytghd/HyprCapture) - The best screenshot tool for Hyprland
...
*   [savonovv/hypr-kinetic-scroll](https://github.com/savonovv/hypr-kinetic-scroll) - Hyprland plugin that adds compositor-level kinetic (inertial) touchpad scrolling for consistent momentum across apps.

*   [hyprwm/hyprland-plugins](https://github.com/hyprwm/hyprland-plugins) - Official plugins for Hyprland

*   [ernestoCruz05/hycov](https://github.com/ernestoCruz05/hycov) - hyprland overview mode plugin,a new tile window workflow
...
*   [raybbian/hyprtasking](https://github.com/raybbian/hyprtasking) - Powerful workspace management plugin, packed with features
...
*   [gpg/pinentry](https://github.com/gpg/pinentry) - The standard pinentry collection. NOTE: Maintainers are not tracking this mirror. Do not make pull requests here, nor comment any commits, submit them usual way to bug tracker (https://www.gnupg.org/documentation/bts.html) or to the mailing list (https://www.gnupg.org/documentation/mailing-lists.html).

*   [sdevil7th/OpenStudio](https://github.com/sdevil7th/OpenStudio) - DAW and Jam Station for the new era

*   [jrohel/NetMount](https://github.com/jrohel/NetMount) - NetMount allows DOS to mount directories from remote computers as network drives.

*   [NyaMisty/KernInfra](https://github.com/NyaMisty/KernInfra) - KernInfra, a unified kernel operation framework
...
*   [harlos0517/midivfx](https://github.com/harlos0517/midivfx) -

*   [forkgram/tdesktop](https://github.com/forkgram/tdesktop) - Fork of Telegram Desktop messaging app.

*   [enummusic/allpassphase](https://github.com/enummusic/allpassphase) - Download under "Releases". Feel free to donate under https://streamlabs.com/enum\_

*   [directvt/vtm](https://github.com/directvt/vtm) - Text-based desktop environment

*   [raboof/nethogs](https://github.com/raboof/nethogs) - Linux 'net top' tool

*   [pankoza2-pl/gdithings](https://github.com/pankoza2-pl/gdithings) - c++ and C# gdi effects (noskid)

*   [pankoza2-pl/Malware2.0Database](https://github.com/pankoza2-pl/Malware2.0Database) - My new malware database, the old one is now archived and all my new malwares will be uploaded here instead. As always, this is made for educational purposes only, I'm not responsible for any damages
...
*   [OpenYSM/YSMParser](https://github.com/OpenYSM/YSMParser) - A Parser to recover Yes-Steve-Model Encrypted Binaries.

*   [Samsung/rlottie](https://github.com/Samsung/rlottie) - A platform independent standalone library that plays Lottie Animation.

*   [fjqisba/E-Decompiler](https://github.com/fjqisba/E-Decompiler) - 用来辅助分析易语言程序的IDA插件

*   [clay-ui-rs/clay](https://github.com/clay-ui-rs/clay) - Rust bindings for Clay, a UI layout library written in C.

*   [Cvolton/betterinfo-geode](https://github.com/Cvolton/betterinfo-geode) - BetterInfo for Geode

*   [WayfireWM/wayfire](https://github.com/WayfireWM/wayfire) - A modular and extensible wayland compositor

*   [Yuria-Shikibe/xrgui](https://github.com/Yuria-Shikibe/xrgui) - 一个轻量级的保留式GUI组件
...
*   [Rob--/memoryjs](https://github.com/Rob--/memoryjs) - Read and write process memory in Node.js (Windows API functions exposed via Node bindings)
...
*   [iso2t/FFS](https://github.com/iso2t/FFS) - RAW POWER OF DIRECT MEMORY FUCKERY
...
*   [timothy-barnes-2357/Build-with-Bombs](https://github.com/timothy-barnes-2357/Build-with-Bombs) - Voxel diffusion AI for Minecraft
...
*   [EnderMo/VinaUI](https://github.com/EnderMo/VinaUI) - A UI foundation that simple and light
...
*   [dusk-audio/dusk-audio-plugins](https://github.com/dusk-audio/dusk-audio-plugins) - All of my plugins
...
*   [YuFeng926/OpenTune](https://github.com/YuFeng926/OpenTune) - OpenTune 是一款基于神经声码器 PC-NSF-HifiGan 与先进音高提取技术（RMVPE & FCPE）的新一代音高修正软件。它可在一个八度内实现更自然的移调；内置智能识别调式&自动修音功能，并对低质量音频素材具备更优秀的音高识别能力——在处理齿音、高频声音时，不会像 Auto-Tune 那样引入额外的渲染噪声，保持声音干净自然。

*   [arangodb/arangodb](https://github.com/arangodb/arangodb) - 🥑 ArangoDB is a native multi-model database with flexible data models for documents, graphs, and key-values. Build high performance applications using a convenient SQL-like query language or JavaScript extensions.

*   [lotem/librime-octagram](https://github.com/lotem/librime-octagram) - RIME〖八股文〗語法插件

*   [NixOS/nix](https://github.com/NixOS/nix) - Nix, the purely functional package manager

*   [yankeguo/wioterminal-mnemonic](https://github.com/yankeguo/wioterminal-mnemonic) - create BIP39 mnemonic with wio terminal arduino

*   [pichenettes/eurorack](https://github.com/pichenettes/eurorack) - Eurorack modules

*   [samuelscheit/wplace-archive](https://github.com/samuelscheit/wplace-archive) -

*   [PenUniverse/PenMods](https://github.com/PenUniverse/PenMods) - 🔥 A third-party mod runtime for YoudaoDictPen.

*   [react/react-native](https://github.com/react/react-native) - A framework for building native applications using React

*   [NikolaiVChr/Autinn](https://github.com/NikolaiVChr/Autinn) - Autinn VCV Rack plugin

*   [Mr-Hamza1001/RoomReverb](https://github.com/Mr-Hamza1001/RoomReverb) - 🔊 Simulate room acoustics with this JUCE-based audio plugin that generates realistic reverb using ray-tracing techniques for improved sound design.

*   [EndstoneMC/endstone](https://github.com/EndstoneMC/endstone) - High-performance Minecraft Bedrock server software with native C++ and Python plugin API
...
*   [AuroraWright/LunaTranslator](https://github.com/AuroraWright/LunaTranslator) - Galgame翻译器，支持HOOK、OCR、剪贴板等。Visual Novel Translator , support HOOK / OCR / clipboard
...
*   [project-yui/Yui-native](https://github.com/project-yui/Yui-native) -

*   [project-yui/Yui-patch](https://github.com/project-yui/Yui-patch) - Yui校验拦截模块

*   [Chenx221/Textractor](https://github.com/Chenx221/Textractor) - Extracts text from video games and visual novels. Highly extensible.

*   [Lefraudeur/MinHookDisabler](https://github.com/Lefraudeur/MinHookDisabler) - Small external program that will attempt to detect and disable minhook hooks in a process
...
*   [Lamina-dev/Lamina](https://github.com/Lamina-dev/Lamina) - 欲了解更多，前往组织主页
...
*   [BlokCAT/PathTracing-CUDA](https://github.com/BlokCAT/PathTracing-CUDA) - A soft ray tracing renderer based on Monte Carlo integration path tracing, implemented using pure C++ and file output streams.使用纯C++和文件输出流实现的一个基于蒙德卡罗积分路径追踪的软光线追踪渲染器
...
*   [LiZhiY0u/ESP32\_connect\_XboxController](https://github.com/LiZhiY0u/ESP32_connect_XboxController) - ESP32通过BLE蓝牙连接Xbox手柄读取所有的信号(ESP32 reads all the signals from the Xbox controller via BLE connection)
...
*   [ChefKissInc/NootedRed](https://github.com/ChefKissInc/NootedRed) - The unsupported AMD GPU support kext.
...
*   [zerospades/zerospades](https://github.com/zerospades/zerospades) - OpenSpades modified to some extent
...
*   [vxcall/Dainsleif](https://github.com/vxcall/Dainsleif) - :zap: an open source hack for Counter-Strike: Global Offensive.
...
*   [chcg/NPP\_HexEditor](https://github.com/chcg/NPP_HexEditor) - Notepad++ Plugin HexEditor
...
*   [hralet1/cavalry-assistant](https://github.com/hralet1/cavalry-assistant) - Create with Cavalry from AI. An MCP server that gives your AI assistant a direct line into Cavalry — run scripts, query the knowledge base, and animate from a prompt.
...
*   [sunblaze-ucb/cybergym](https://github.com/sunblaze-ucb/cybergym) - CyberGym is a large-scale, high-quality cybersecurity evaluation framework designed to rigorously assess the capabilities of AI agents on real-world vulnerability analysis tasks.
...
*   [otoDB/otoDB](https://github.com/otoDB/otoDB) - Database, forum, and wiki for 音MAD/YTPMV
...
*   [freddykat/CDJ1000-Nexus-MOD](https://github.com/freddykat/CDJ1000-Nexus-MOD) - This is a on-going project to create a skin for DJ software "MIXXX" to make a CDJ1000mk3 MIDI moded work as a Nexus CDJ2000 model
...
*   [ProbiusOfficial/owasp2025-top10-ctf](https://github.com/ProbiusOfficial/owasp2025-top10-ctf) - 基于 OWASP Top 10:2025 的 CTF 竞赛题目集，共 24 道 Web 安全挑战题，支持动态 Flag 注入

*   [NyarchLinux/NyarchAssistant](https://github.com/NyarchLinux/NyarchAssistant) - Nyarch Linux Assistant (Newelle Fork)
...
*   [agi-mafia/mafia](https://github.com/agi-mafia/mafia) -

*   [open-mafia/open\_mafia\_engine](https://github.com/open-mafia/open_mafia_engine) - Open-source, extendable mafia engine

*   [ireza7/WereWolf-Engine](https://github.com/ireza7/WereWolf-Engine) -

*   [PizzaDark/AutoMemeDetector](https://github.com/PizzaDark/AutoMemeDetector) -
...
*   [lumina37/rotate-captcha-crack](https://github.com/lumina37/rotate-captcha-crack) - 基于CNN的旋转验证码解决方案✨Predict the rotation angle of given captcha picture through CNN

*   [lumina37/aiotieba](https://github.com/lumina37/aiotieba) - 贴吧接口合集✨可用于工具箱/吧务管理/数据采集

*   [astral-sh/ty](https://github.com/astral-sh/ty) - An extremely fast Python type checker and language server, written in Rust.

*   [ChenXu233/nonebot-plugin-safeR18](https://github.com/ChenXu233/nonebot-plugin-safeR18) -

*   [angristan/fast-resume](https://github.com/angristan/fast-resume) - Find that one coding agent session you want to get back to!

*   [xuyuzhuang11/Werewolf](https://github.com/xuyuzhuang11/Werewolf) -

*   [MemPalace/mempalace](https://github.com/MemPalace/mempalace) - The best-benchmarked open-source AI memory system. And it's free.

*   [dreamrec/LivePilot](https://github.com/dreamrec/LivePilot) - Agentic production system for Ableton Live 12 — 467 tools across 56 domains. Device atlas, user corpus, Splice intelligence, 9-band spectral perception, Creative Director, semantic moves, and 12 creative engines.
...
*   [yxc20089/OpenRA-RL](https://github.com/yxc20089/OpenRA-RL) - Open Framework for AI Agents to play Red Alert through Reinforcement Learning

*   [LaoZhong-Mihari/codex-organic-chem](https://github.com/LaoZhong-Mihari/codex-organic-chem) - Codex skill and local CLI/MCP toolchain for organic chemistry reasoning

*   [angr/angr](https://github.com/angr/angr) - A powerful and user-friendly binary analysis platform!

*   [JonasLong/Pyison](https://github.com/JonasLong/Pyison) - Pythonic AI crawler tarpit

*   [Whyaremax/ILoveOpenYSM](https://github.com/Whyaremax/ILoveOpenYSM) - Open Yes Steve Model (YSM) extractor and Minecraft player model decoder

*   [microsoft/autogen](https://github.com/microsoft/autogen) - A programming framework for agentic AI

*   [roex-audio/dawproject-py](https://github.com/roex-audio/dawproject-py) - dawproject-py – A Python repository with code for parsing, generating, and modifying DAWProject files, enabling seamless DAW interoperability.

*   [Donitzo/ai-pixelart-extractor](https://github.com/Donitzo/ai-pixelart-extractor) - A more robust Python-based process to extract AI-generated pixel-art

*   [theamusing/perfectPixel](https://github.com/theamusing/perfectPixel) - Refine and quantize messy AI pixel art into clean, perfect pixels.

*   [x0x0b/ComfyUI-spritefusion-pixel-snapper](https://github.com/x0x0b/ComfyUI-spritefusion-pixel-snapper) - ComfyUI integration of spritefusion-pixel-snapper for pixel-art processing.
...
*   [Foadsf/es-tui](https://github.com/Foadsf/es-tui) - A feature-rich terminal interface for Everything Search that provides fast, intuitive file searching when Windows Explorer fails you.

*   [aloshdenny/reverse-SynthID](https://github.com/aloshdenny/reverse-SynthID) - reverse engineering Gemini's SynthID detection

*   [Umkus/ip-index](https://github.com/Umkus/ip-index) - A custom MMDB database, helping detect country, ASN and hosting.

*   [Arindam200/awesome-ai-apps](https://github.com/Arindam200/awesome-ai-apps) - A collection of projects showcasing RAG, agents, workflows, and other AI use cases

*   [yfchen1994/scaling\_camouflage](https://github.com/yfchen1994/scaling_camouflage) -

*   [K0nGbawa/only-60fps-can-see](https://github.com/K0nGbawa/only-60fps-can-see) - 把一个60帧的视频转换成一个上传到B站后只有60帧画质能看到的视频

*   [Tencent-Hunyuan/Hy3-preview](https://github.com/Tencent-Hunyuan/Hy3-preview) - Hy3 preview (295B A21B), a leading reasoning and agent model in its size, with great cost efficiency

*   [simple-login/app](https://github.com/simple-login/app) - The SimpleLogin back-end and web app

*   [altaidevorg/afterimage](https://github.com/altaidevorg/afterimage) - Generate conversational, tool-calling, structured-output, and preference datasets — easily and at scale

*   [caronc/apprise](https://github.com/caronc/apprise) - Apprise - Push Notifications that work with just about every platform!

*   [blacklight/madblog](https://github.com/blacklight/madblog) - A minimal platform for Markdown-based blogs

*   [approximatelabs/pencil-puzzle-bench](https://github.com/approximatelabs/pencil-puzzle-bench) -
...
*   [Xtremerspro/Large-Photos-Blender](https://github.com/Xtremerspro/Large-Photos-Blender) - A simple few step process to render astronomically large renders in blender
...
*   [neu-vi/houseCrafter](https://github.com/neu-vi/houseCrafter) - code release for HouseCrafter (ICCV 2025 Highlight)
...
*   [sudoskys/tsticker](https://github.com/sudoskys/tsticker) - Telegram Sticker Utils | Make Sticker from git-like CLI

*   [ysong1231/SimRank](https://github.com/ysong1231/SimRank) - An implementation of SimRank and SimRank++ algorithms on both directive graphs and bipartitle graphs, with matrix manipulations to reduce the calculation complexity effectively.
...
*   [The2AndOnly/fnaf-python-bot](https://github.com/The2AndOnly/fnaf-python-bot) - Python script that can unlock 3 stars in Fnaf 1
...
*   [Iceface-microtonal/semantic-topology-synthesizer](https://github.com/Iceface-microtonal/semantic-topology-synthesizer) - STS — Semantic Topology Synthesizer: a web-based synthesizer with semantic topology visualization
...
*   [roitium/echo](https://github.com/roitium/echo) -
...
*   [shixiaogaoya/MemoTrace](https://github.com/shixiaogaoya/MemoTrace) - 提取微信聊天记录，将其导出成HTML、Word、CSV文档永久保存，对聊天记录进行分析生成年度聊天报告
...
*   [Flowtter/crispy](https://github.com/Flowtter/crispy) - Crispy is a machine-learning platform to make video-games montages efficiently. It uses a neural network to detect highlights in the video-game frames

*   [peeringdb/peeringdb](https://github.com/peeringdb/peeringdb) - Server code for https://www.peeringdb.com/

*   [ltsdw/gofile-downloader](https://github.com/ltsdw/gofile-downloader) - Download files from https://gofile.io
...
*   [milan090/benchmark-servers](https://github.com/milan090/benchmark-servers) - Nginx vs Caddy vs Treafik

*   [enodari/zwsp-steg-py](https://github.com/enodari/zwsp-steg-py) -  Zero-Width Space Steganography, encodes/decodes hidden messages as non printable/readable characters.
...
*   [Polydet/polyglot-database](https://github.com/Polydet/polyglot-database) - Database of polyglot files. By polyglot, we mean files readable in multiple formats

*   [LiteyukiStudio/nonebot-plugin-marshoai](https://github.com/LiteyukiStudio/nonebot-plugin-marshoai) - NoneBot2 猫娘聊天插件

*   [Zeecka/AperiSolve](https://github.com/Zeecka/AperiSolve) - Steganalysis web platform

*   [google/scaaml](https://github.com/google/scaaml) - SCAAML: Side Channel Attacks Assisted with Machine Learning
...
*   [ddsggcs/ai\_model\_samples](https://github.com/ddsggcs/ai_model_samples) - 本仓库包含一些 AI 模型的 demo，查看 README 了解更多详细信息。
...
*   [via007/bilibili-rag](https://github.com/via007/bilibili-rag) - B站收藏夹RAG知识库：收藏不吃灰，B 站收藏夹 → 语音转写 → 向量检索 → 对话问答

*   [goauthentik/authentik](https://github.com/goauthentik/authentik) - The authentication glue you need.

*   [yfishyon/chongchong-free-python](https://github.com/yfishyon/chongchong-free-python) - 免费下载虫虫钢琴琴谱
...
*   [Godheritage/BesiegeField](https://github.com/Godheritage/BesiegeField) - Official repo of BesiegeField, an interactive and real-time environment for machine construction and simulation (arXiv:2510.14980).
...
*   [rehanguha/brisque](https://github.com/rehanguha/brisque) - Blind/Referenceless Image Spatial QUality Evaluator (BRISQUE)
...
*   [guanzhujiaran/BilibiliExplosion](https://github.com/guanzhujiaran/BilibiliExplosion) - 自用的B站脚本
...
*   [CalmXin/xin-api](https://github.com/CalmXin/xin-api) - 欢迎来到SkyQian的API，大部分功能都是自行实现，而非盗用所谓的第三方接口，套娃行为可没什么意思。
...
*   [qqqqqf-q/MirrorFlow](https://github.com/qqqqqf-q/MirrorFlow) - 从对话数据到训练:数字分身 + 模型蒸馏   From Dialogue Data to Training Closed-Loop: Digital Twin + Model Distillation
...
*   [ChaceQC/bilibili\_live\_stream\_code](https://github.com/ChaceQC/bilibili_live_stream_code) - 获取B站直播推流码，支持开关播，管理直播标题、分区，显示弹幕和礼物。
...
*   [eldek0/fnaf-in-pygame](https://github.com/eldek0/fnaf-in-pygame) - Five Nights at Freddy's in Python
...
*   [terrified9/turnaround-api](https://github.com/terrified9/turnaround-api) - Cloudflare Turnstile solving API
...
*   [krau/kmua-bot](https://github.com/krau/kmua-bot) -  💕 咪咪咪咪咪咪咪咪咪
...
*   [PILIHU2022/My-dotfiles](https://github.com/PILIHU2022/My-dotfiles) - My working environment. It tends to be stable. It will have fewer update, so that I can put my heart in learning and coding
...
*   [shinnpuru/VoiceTransl](https://github.com/shinnpuru/VoiceTransl) - VoiceTransl灵译是一站式离线AI视频字幕生成和翻译软件，支持Mac，Windows。功能包括视频下载，音频提取，听写打轴，字幕翻译，视频合成，字幕总结。
...
*   [CuriousLearnerDev/Online\_tools](https://github.com/CuriousLearnerDev/Online_tools) - 该工具专为运维和安全检查和学习研究设计，类似于软件商城，可以实现工具下载、更新，并提供自动化安装脚本。内置了HexStrike-Ai可以通过AI调用里面工具实现自动化扫描。不用担心工具无法正常运行配置，提升效率。
...
*   [87owo/PYAS](https://github.com/87owo/PYAS) - Antivirus software written in Python and C++ that blocks threats through Machine Learning and behavioral monitoring!
...
*   [AnonymousX1025/AnonXMusic](https://github.com/AnonymousX1025/AnonXMusic) - Telegram Group Calls Streaming bot with some useful features, written in Python with Pyrogram and Py-Tgcalls. Supporting platforms like Youtube, Spotify, AppleMusic and M3u8 Links.
...
*   [MCSLTeam/MCSL2](https://github.com/MCSLTeam/MCSL2) - MCSL2 | A sleek and versatile Minecraft Server Launcher
...
*   [prescientmoon/everything-nix](https://github.com/prescientmoon/everything-nix) - (MIRROR) Personal nixos / home-manager configurations
...
*   [hexadecimal233/nix-cavalry](https://github.com/hexadecimal233/nix-cavalry) - WIP: Running Cavalry on NixOS

*   [numtide/blueprint](https://github.com/numtide/blueprint) - Standard folder structure for Nix projects

*   [DoomHammer/dotfiles](https://github.com/DoomHammer/dotfiles) - My private dotfiles.
...
*   [JeffreyBenjaminBrown/nixos-experiments](https://github.com/JeffreyBenjaminBrown/nixos-experiments) -
...
*   [RyanGibb/nixos](https://github.com/RyanGibb/nixos) - btw i use nix
...
*   [berberman/nix-optics](https://github.com/berberman/nix-optics) - Naive implementation of Profunctor Optics in Nix

*   [yunfachi/NixOwOS](https://github.com/yunfachi/NixOwOS) - Complete redesign of NixOS into real m-man distwibution, featuring updated logos, renamed distro, and more

*   [n0099/nixos](https://github.com/n0099/nixos) -
...
*   [daskladas/nasdots](https://github.com/daskladas/nasdots) - Declarative NixOS NAS configuration for the Ugreen DXP4800 Plus — RAID, NFS, monitoring, all in Nix.
...
*   [scenery-io/cavalry-types](https://github.com/scenery-io/cavalry-types) - Typescript definitions for Cavalry
...
*   [tha23rd/recaf-mcp](https://github.com/tha23rd/recaf-mcp) - MCP server plugin for Recaf — enabling AI agents to perform Java reverse engineering

*   [Col-E/SourceSolver](https://github.com/Col-E/SourceSolver) - A lightweight wrapper on the javac API to support resolving class and member references in a String of Java source code.
...
*   [PhantomWing/RusticDelight](https://github.com/PhantomWing/RusticDelight) -

*   [WW92030-STORAGE/THE-SPECTATOR](https://github.com/WW92030-STORAGE/THE-SPECTATOR) - The Witness in Minecraft! 1.20.1

*   [Sollace/Psychedelicraft](https://github.com/Sollace/Psychedelicraft) - Drug experience mod for Minecraft

*   [Ivorforce/Psychedelicraft](https://github.com/Ivorforce/Psychedelicraft) - Drug experience mod for Minecraft

*   [TudbuT/csac](https://github.com/TudbuT/csac) - ClientSideAntiCheat for minecraft
...
*   [cardillan/mindcode](https://github.com/cardillan/mindcode) - A high level language for Mindustry Logic (mlog) and Mindustry Schematics.

*   [IzumiiKonata/OpenYSM-Updated](https://github.com/IzumiiKonata/OpenYSM-Updated) - OpenYSM 的 fabric 的高版本移植。

*   [Nippaku-Zanmu/Seija-Printer](https://github.com/Nippaku-Zanmu/Seija-Printer) - Advanced Litematica Printer for Minecraft

*   [unnamed/mocha](https://github.com/unnamed/mocha) - A lightweight, fast and efficient Molang lexer, parser, interpreter and compiler for Java 8+

*   [OpenYSM/OpenYSM](https://github.com/OpenYSM/OpenYSM) - Yes-Steve-Model idea ready.

*   [LopyMine/PatPat](https://github.com/LopyMine/PatPat) - Simple PatPat Fabric mod for patting any mobs!

*   [LSPosed/DirtySepolicy](https://github.com/LSPosed/DirtySepolicy) -

*   [pilgrimage233/Minecraft-Rcon-Manage](https://github.com/pilgrimage233/Minecraft-Rcon-Manage) - 🔥 全新开源！专为Minecraft服务器主打造的全能管理方案，基于RuoYi-Vue框架开发，三大核心功能助力高效运维： ✨ 核心亮点： ✅ 多服务器统一仪表盘 - 实时状态/在线玩家/远程指令一站式管理 ✅ 智能白名单系统 - 正版验证+自动审核+邮件通知+IP防护 ✅ 全维度玩家管理 - 游戏行为追踪/时长统计/地理分布/封禁系统 💻 进阶功能： RCON远程控制 + 网页版终端 OP权限日志 + 操作审计追踪 定时任务系统 + 数据可视化报表 玩家历史ID + 多服务器同步管理 📦 适合人群： 正在为服务器运维头疼的服主｜需要多服管理的团队｜追求自动化管理的技术型玩家

*   [honeypie3301/Backwoods](https://github.com/honeypie3301/Backwoods) - Everything is wood.
...
*   [XHUBERTH/NekoCheck](https://github.com/XHUBERTH/NekoCheck) - Tracking of malware embedded into Nekogram
...
*   [psal/jstylo](https://github.com/psal/jstylo) - JStylo-Anonymouth - Authorship Attribution and Authorship Anonymization Framework

*   [Oak-and-fire/Fractured-Distance](https://github.com/Oak-and-fire/Fractured-Distance) - As you go further and further from spawn, the terrain, structures, mobs, blocks, items, and physics of Minecraft start to slowly corrupt

*   [Yucareux/Tellus](https://github.com/Yucareux/Tellus) -
...
*   [The-Aether-Team/The-Aether-II](https://github.com/The-Aether-Team/The-Aether-II) - The Aether II is the sequel to the highly popular dimension mod "The Aether" for modern versions of Minecraft.

*   [shiroha-233/MC-MMD-rust](https://github.com/shiroha-233/MC-MMD-rust) -

*   [PowerNukkitX/PowerNukkitX](https://github.com/PowerNukkitX/PowerNukkitX) - Open-source, feature-rich Minecraft: Bedrock Edition server written in Java. Supports custom items, blocks, entities, full vanilla commands, advanced mob AI, and world generation. Not affiliated with Mojang AB.
...
*   [MeteorClientPlus/MeteorPlus](https://github.com/MeteorClientPlus/MeteorPlus) - An addon for Meteor client that adds many blatant features.
...
*   [Not-a-Tyler/Mossura](https://github.com/Not-a-Tyler/Mossura) -

*   [Novinity/ClientID](https://github.com/Novinity/ClientID) - Check your players' mod and resource pack list.
...
*   [atwaomar/MediaPlayer](https://github.com/atwaomar/MediaPlayer) - Allows you to play and use various medias such as videos on Minecraft.
...
*   [KiltMC/Kilt](https://github.com/KiltMC/Kilt) - A Fabric mod that brings (Neo)Forge mods into the Fabric ecosystem.
...
*   [FPSMasterTeam/FPSMaster-Edge](https://github.com/FPSMasterTeam/FPSMaster-Edge) - FPSMaster Client Open Source
...
*   [NekoyaHouse/nsm](https://github.com/NekoyaHouse/nsm) - NoSteveModel - Decrypt YSM Files
...
*   [florianreuth/WaybackAuthLib](https://github.com/florianreuth/WaybackAuthLib) - Addon for Mojang's AuthLib to support Yggdrasil authentication again
...
*   [GaleMC/Gale](https://github.com/GaleMC/Gale) - The reliable high-performance Minecraft server fork.
...
*   [Silversmith-Mods/Spelunkery](https://github.com/Silversmith-Mods/Spelunkery) - The Spelunkery mod for Minecraft
...
*   [LOOHP/Limbo](https://github.com/LOOHP/Limbo) - Standalone Limbo Minecraft Server (Currently 26.2)
...
*   [PlaceholderAPI/PlaceholderAPI](https://github.com/PlaceholderAPI/PlaceholderAPI) - The best and simplest way to add placeholders to your server! - 2M+ Downloads - 3.5k+ Placeholders
...
*   [DreamVoid/MiraiMC](https://github.com/DreamVoid/MiraiMC) - 适用于 Minecraft 服务器的 mirai 机器人
...
*   [ScreamingSandals/BedWars](https://github.com/ScreamingSandals/BedWars) - Simple BedWars minigame plugin for Paper/Spigot version 1.8.8 - 26.2
...
*   [ZetaMap/MoreCommands](https://github.com/ZetaMap/MoreCommands) - Useful for small servers, this plugin adds a bunch of new commands (60+) to your server.
...
*   [mindustry-antigrief/mindustry-client](https://github.com/mindustry-antigrief/mindustry-client) - A custom client for mindustry supporting v5, v6, v7 and v8! Also known as Foo's client.
...
*   [a1098832322/shimeji](https://github.com/a1098832322/shimeji) - 基于Shimeji ee项目构建的一个私人魔改桌宠小项目，基于JDK11及Maven环境构建，支持Windows和MacOS
...
*   [KangweiZhu/lyrics-on-panel](https://github.com/KangweiZhu/lyrics-on-panel) - Lyrics-on-panel: A widget that displays the lyrics of the currently playing song from Spotify, Netease Cloud Music, Elisa, etc., on any location of your desktop. Now supporting KDE, Niri, Hyprland, inspired by the MacOS Netease Cloud Music Top Panel Lyrics。
...
*   [xxfast/fabric-witness](https://github.com/xxfast/fabric-witness) - A fabric mod for The Witness Minecraft
...
*   [juanma0511/kknd\_Root\_Detector](https://github.com/juanma0511/kknd_Root_Detector) - A tool to detect root on Android.

*   [cao-awa/Kora](https://github.com/cao-awa/Kora) - Kora is an experimental high-performance, type-safe, lifecycle-driven, effect-based JVM runtime for service execution, with out-and-out descriptive DSL.

*   [KIPPUDESU/KIPPU\_Trace](https://github.com/KIPPUDESU/KIPPU_Trace) - 一个记录重要时刻，功能简单且界面美观的安卓原生 App，将持续收取建议跟进开发。目的是在界面和体验上一定程度超越替代倒数日

*   [YumeYucca/YumeBox](https://github.com/YumeYucca/YumeBox) - An open-source Android client based Mihomo

*   [JetBrains/ideavim](https://github.com/JetBrains/ideavim) - IdeaVim – A Vim engine for JetBrains IDEs

*   [X1nto/AliucordPlugins](https://github.com/X1nto/AliucordPlugins) - A collection of plugins for Aliucord.

*   [Yizuka17/YumeBox-MaterialDesign](https://github.com/Yizuka17/YumeBox-MaterialDesign) - A Material Design fork of YumeBox, an open-source Android client based on Mihomo.
...
*   [afoim/local-dream](https://github.com/afoim/local-dream) - 自用+ 自动prompt | Run Stable Diffusion on Android Devices with Snapdragon NPU acceleration. Also supports CPU/GPU inference.

*   [C0C0B01/KettuXposed](https://github.com/C0C0B01/KettuXposed) - An Xposed module to inject Kettu, a mod for Discord's mobile apps.

*   [thunderbird/thunderbird-android](https://github.com/thunderbird/thunderbird-android) - Thunderbird for Android – Open Source Email App for Android (fka K-9 Mail)

*   [JamGmilk/FuwaGit](https://github.com/JamGmilk/FuwaGit) - FuwaGit is a lightweight and powerful Git client for Android that brings full Git operations to mobile devices with secure credential management and a modern UI.
...
*   [huanli233/psychonautwiki-journal-android](https://github.com/huanli233/psychonautwiki-journal-android) - PsychonautWiki Journal is an Android app to make recreational drug users safer.

*   [gurecn/yuyansdk](https://github.com/gurecn/yuyansdk) - 语燕输入法引擎-一款基于Rime定制开发的九键、全拼、双拼、手写、火星文等方案、支持悬浮、单手、数字行等模式的中文输入法引擎

*   [ohdj/NfcAimeReader](https://github.com/ohdj/NfcAimeReader) - 一个通过安卓手机 NFC 读取 Aime 卡片为 SEGA / KONAMI 系游戏刷卡的项目
...
*   [NaiveTomcat/HRTTracker](https://github.com/NaiveTomcat/HRTTracker) -
...
*   [MewoLab/AquaDX](https://github.com/MewoLab/AquaDX) - A magical server for certain arcade rhythm games 🪄
...
*   [hax0r31337/ProtoHax](https://github.com/hax0r31337/ProtoHax) - MITM cheat for Minecraft: PE (No longer MITM on 2.x)
...
*   [SparkUniverse/Elementa](https://github.com/SparkUniverse/Elementa) - A simple, declarative GUI library for Minecraft
...
*   [Project-Kiri/Kiri-Friends](https://github.com/Project-Kiri/Kiri-Friends) - A bidirectional watchOS companion for Claude, OpenCode, and Codex CLI.
...
*   [Stmol/ssh-keys-manager-macos-app](https://github.com/Stmol/ssh-keys-manager-macos-app) - A native macOS app for managing SSH keys, editing SSH config entries, and safely organizing your local SSH workspace.
...
*   [lbrndnr/nuage-macos](https://github.com/lbrndnr/nuage-macos) - Native SoundCloud app for macOS, written in SwiftUI
...
*   [smallzhong/NeacController](https://github.com/smallzhong/NeacController) - Exploit vulnerabilities in NeacSafe64.sys to achieve privilege escalation and kernel-mode shellcode execution

*   [alsa-project/alsa-ucm-conf](https://github.com/alsa-project/alsa-ucm-conf) - ALSA Use Case Manager configuration

*   [djraw/Traktmixxx-RAW](https://github.com/djraw/Traktmixxx-RAW) - A 4-deck full-featured and resizable skin for MIXXX. Using a Traktor similar color scheme and more

*   [22degrees/RoundCorners](https://github.com/22degrees/RoundCorners) - A 4-deck full-featured and resizable skin for MIXXX.
...
*   [lechmazur/sycophancy](https://github.com/lechmazur/sycophancy) - LLM benchmark and leaderboard for narrator-bias sycophancy, opposite-narrator contradictions, and judgment consistency.
...
*   [songpola/debug-nixos-amd-gpu-accel](https://github.com/songpola/debug-nixos-amd-gpu-accel) -
...
*   [pankoza2-pl/salinewin.exe-Malware](https://github.com/pankoza2-pl/salinewin.exe-Malware) - C++ GDI Malware. I'm not responsible for any damages

*   [microsoft/Pride-flag](https://github.com/microsoft/Pride-flag) - Pride flag featuring 74 individual LGBTQIA+ flags

*   [TheAudioProgrammer/claude-audio-plugin-project-planner-skill](https://github.com/TheAudioProgrammer/claude-audio-plugin-project-planner-skill) -

*   [ClearskyApp06/clearskyservices](https://github.com/ClearskyApp06/clearskyservices) - Clearsky Services API
...
*   [letientai299/heisenbugs](https://github.com/letientai299/heisenbugs) - List of strange bugs
...
*   [sisong/sfpatcher](https://github.com/sisong/sfpatcher) - stable & fast to patch apk archives, used by Android app store. 为安卓应用商店使用而优化的apk增量更新算法。

*   [Warren2060/ChillRound](https://github.com/Warren2060/ChillRound) - 圆体字体拓展计划立项
...
*   [kaushiktarun05/packet\_tracer](https://github.com/kaushiktarun05/packet_tracer) - This repository contains a collection of the most important .pkt files

*   [surrealdb/awesome-surreal](https://github.com/surrealdb/awesome-surreal) - A curated list of SurrealDB resources, tools, utilities, and applications.
...
*   [BleuBleu/KiraStudioPublic](https://github.com/BleuBleu/KiraStudioPublic) -
...
*   [robinwalterfit/biome-standard](https://github.com/robinwalterfit/biome-standard) - A port of the StandardJS ESLint config to Biome.

*   [ivangabriele/biome-config](https://github.com/ivangabriele/biome-config) - My custom Biome configuration.

*   [ruanyf/weekly](https://github.com/ruanyf/weekly) - 科技爱好者周刊，每周五发布

*   [BTtea/CVE-2026-20841-PoC](https://github.com/BTtea/CVE-2026-20841-PoC) - PoC
...
*   [igorbabko/vscode-setup](https://github.com/igorbabko/vscode-setup) -
...
*   [Benzyl-titanium/Structural-formula](https://github.com/Benzyl-titanium/Structural-formula) - 管制药品结构式目录（2026年版）
...
*   [PTALTS-LK/RKD-OLD](https://github.com/PTALTS-LK/RKD-OLD) - 一个基于RP2040+CH9329的4k音游控制器/可编程键盘 支持扩展 硬件宏 SDVX v1.1版本正在开发中
...
*   [KaiijuMC/Kaiiju](https://github.com/KaiijuMC/Kaiiju) - Multithreaded & Vanilla server implementation (Folia Fork)
...
*   [taptap/tapsdk-v3-android](https://github.com/taptap/tapsdk-v3-android) - TapSDK v3 Android 产物仓库
...
*   [ouyangzhaoxing/rec\_lite](https://github.com/ouyangzhaoxing/rec_lite) - 轻量便携的屏幕录制工具。(Lightweight and portable screen recording tool.) -- Windows11自带的录制已经较为完善，该工具已经没维护的必要。
...
*   [trailofbits/HVCI-loldrivers-check](https://github.com/trailofbits/HVCI-loldrivers-check) -
...
*   [LuanRT/yt-sabr-shaka-demo](https://github.com/LuanRT/yt-sabr-shaka-demo) - Demonstration of a SABR/UMP player implementation using Shaka Player.

*   [Zephyruso/zashboard](https://github.com/Zephyruso/zashboard) -

*   [nomdn/dress-api](https://github.com/nomdn/dress-api) - 基于dress项目的随机图片api

*   [rcy1314/echo-noise](https://github.com/rcy1314/echo-noise) - 轻博客风格可自由切换多栏布局，面向个人的高度自定义场景的说说笔记系统

*   [EIHRTeam/End-WikiPlus](https://github.com/EIHRTeam/End-WikiPlus) - Endfield Wikiplus, the cross-platform open-source toolbox for SKLAND / SKPORT Endfield Wiki
...
*   [proj-airi/duckdb-wasm](https://github.com/proj-airi/duckdb-wasm) - 🦆📊 Easy to use wrapper and Drizzle ORM driver for DuckDB WASM
...
*   [TNXG/revue-interlude](https://github.com/TNXG/revue-interlude) -
...
*   [KIRAKIRA-DOUGA/KIRAKIRA-Cerasus](https://github.com/KIRAKIRA-DOUGA/KIRAKIRA-Cerasus) - KIRAKIRA's web frontend powered by Nuxt.
...
*   [6owen/arvin](https://github.com/6owen/arvin) - 个人网站
...
*   [lainsce/emulsion](https://github.com/lainsce/emulsion) - Store your palettes in an easy way, and edit them if needed.
...
*   [dwilliam62/hyprland-btw](https://github.com/dwilliam62/hyprland-btw) - Super simple  NixOS hyprland with flake and home manager

*   [hcrk9/signmaker](https://github.com/hcrk9/signmaker) - An HTML based viewfinding signage maker.
...
*   [Unclecheng-li/AI\_Animation](https://github.com/Unclecheng-li/AI_Animation) - 本项目整理了用于生成\[炫酷 HTML 动画网页]的 AI Prompts，涵盖动画效果、3D 可视化、PPT 风格演示、UI 美化等多个类别。

*   [Unclecheng-li/AI-Animation-Skill](https://github.com/Unclecheng-li/AI-Animation-Skill) - 使用 AI 生成 HTML 演示动画的工具集，让视频创作者能够快速将科普文本转换为炫酷的演示动画。

*   [hekate2/buttonmaker](https://github.com/hekate2/buttonmaker) - A simple 88x31 button maker
...
*   [NNNullptr/MoeKernel\_Desktop](https://github.com/NNNullptr/MoeKernel_Desktop) -

*   [XXIIVV/webring](https://github.com/XXIIVV/webring) - Make yourself a website

*   [botuniverse/onebot-11](https://github.com/botuniverse/onebot-11) - OneBot 11 标准

*   [qwertyaz111/kabedon-floor-simulator](https://github.com/qwertyaz111/kabedon-floor-simulator) - 床ドンシミュレーター
...
*   [Iceface-microtonal/iceface-tdn-geo-rotator](https://github.com/Iceface-microtonal/iceface-tdn-geo-rotator) - Microtonal toy that geometrically rotates notes  Iceface TDN theory based rotating arpeggiator + perfectly synced drum machine. Drag to bend & rotate sounds while generating arpeggios. Harmony and rhythm merge in real-time under Relational-Tonal.  Features: Geometric rotation control, real-time drum sync, mobile-friendly pure HTML/JS web app.

*   [pgsty/pgext](https://github.com/pgsty/pgext) - PG Extension Catalog Utils

*   [schemaorg/schemaorg](https://github.com/schemaorg/schemaorg) - Schema.org - schemas and supporting software

*   [zero-delimiter/TFBOYS](https://github.com/zero-delimiter/TFBOYS) - Texture Forge - the Binary Output YOLO System 文生Minecraft Mod 16x16贴图AI

*   [ClickHouse/ClickBench](https://github.com/ClickHouse/ClickBench) - ClickBench: a Benchmark For Analytical Databases

*   [jsonh-org/Jsonh](https://github.com/jsonh-org/Jsonh) - JSON for Humans.

*   [rocksun/mwblog](https://github.com/rocksun/mwblog) -

*   [ThePHPF/thephp.foundation](https://github.com/ThePHPF/thephp.foundation) -

*   [tedivm/qr\_stencil\_creator](https://github.com/tedivm/qr_stencil_creator) - A website to generate QR Codes that can be turned into stencils.
...
*   [miniyu157/petal-note](https://github.com/miniyu157/petal-note) - 🌸 极简、唯美、无需构建的纯前端碎碎念日记框架
...
*   [tsiresymila1/flutter\_better\_auth](https://github.com/tsiresymila1/flutter_better_auth) - BetterAuth for Dart/Flutter

*   [yuhan2680/Website](https://github.com/yuhan2680/Website) - 小涵的个人网站
...
*   [qcontinuum1/spying-extensions](https://github.com/qcontinuum1/spying-extensions) - Report on spying browser extensions by Q Continuum group.
...
*   [RedByte1337/GraphSpy](https://github.com/RedByte1337/GraphSpy) - Initial Access and Post-Exploitation Tool for Entra ID and M365 with a browser-based GUI
...
*   [fanlusky/haruhikage](https://github.com/fanlusky/haruhikage) - 春日影 (MyGO!!!!! Ver.)
...
*   [wexuo/home](https://github.com/wexuo/home) - 现代化的个人主页，博客主页模板，个人简历模板
...
*   [mirkoschubert/retro-os](https://github.com/mirkoschubert/retro-os) - Portfolio website designed in the style of a retro operating system using SvelteKit

*   [olegpolin/neobrutalism-svelte](https://github.com/olegpolin/neobrutalism-svelte) -

*   [stophecom/scrt-link-v2](https://github.com/stophecom/scrt-link-v2) - Scrt.link lets you share sensitive information online: End-to-end encrypted. Ephemeral. Open source.
...
*   [dindles/beatjie](https://github.com/dindles/beatjie) - Make beats have fun
...
*   [kanakkholwal/orbit](https://github.com/kanakkholwal/orbit) - High-performance PDF toolkit that runs entirely in your browser

*   [Keshav-writes-code/Cherit](https://github.com/Keshav-writes-code/Cherit) - A Markdown Notes taking app inspired by Obsidian
...
*   [joysofcode/sveltekit-markdown-blog](https://github.com/joysofcode/sveltekit-markdown-blog) - 🔥 Markdown blog for poets

*   [wesselgrift/sveltekit-spa](https://github.com/wesselgrift/sveltekit-spa) - A minimal boilerplate for building SPAs with SvelteKit using adapter-static, Supabase Auth, Supabase Postgres and shadcn-svelte UI.
...
*   [tijnjh/cloudscape](https://github.com/tijnjh/cloudscape) - ☁️ minimal ad-free soundcloud client
...
*   [sayaka-sh/LiveRail](https://github.com/sayaka-sh/LiveRail) -

*   [GamesNotDeveloped/godot-forest-demo](https://github.com/GamesNotDeveloped/godot-forest-demo) -

*   [fabian-becker/CSG\_Toolkit](https://github.com/fabian-becker/CSG_Toolkit) -
...
*   [GeorgeEnglezos/Scrcpy-GUI](https://github.com/GeorgeEnglezos/Scrcpy-GUI) - An unofficial beginner-friendly user interface for the Scrcpy Project
...
*   [shiosyakeyakini-info/mfm\_renderer](https://github.com/shiosyakeyakini-info/mfm_renderer) - Flutter Rendering Markup Language for Misskey
...
*   [LastMonopoly/chinese\_font\_library](https://github.com/LastMonopoly/chinese_font_library) - Helper package for rendering Chinese fonts, including cross-platform Chinese font family fallback & dynamic font loader.

*   [muyuzier-afk/FuwariStudio](https://github.com/muyuzier-afk/FuwariStudio) - FuwariStudio is a cross-platform Markdown editor built for managing Fuwari blog repositories. It provides a clean, modern writing experience with split preview, image import/resize, and one-click GitHub sync (download repo on first run, edit posts in src/content/posts/, then commit & push updates).

*   [MtFloveU/autonitor](https://github.com/MtFloveU/autonitor) - A FOSS Twitter follower analysis app that outperforms paid alternatives.

*   [isar/isar](https://github.com/isar/isar) - Extremely fast, easy to use, and fully async NoSQL database for Flutter

*   [fldraw/fldraw](https://github.com/fldraw/fldraw) - The open-source tldraw alternative for building infinite canvas apps in Flutter.
...
*   [yeyushengfan258/Win11-gtk-theme](https://github.com/yeyushengfan258/Win11-gtk-theme) - Win11 like theme for all gtk based desktops
...
*   [delucis/starlight-theme-flexoki](https://github.com/delucis/starlight-theme-flexoki) - Starlight theme based on the Flexoki colour palette

*   [atangccc/Serenity-Grace](https://github.com/atangccc/Serenity-Grace) - 「Serenity」，简约优雅的 Halo 博客主题，以樱花粉与湖水蓝为主色调，支持亮暗模式自由切换。
...
*   [qiwihui/blog](https://github.com/qiwihui/blog) - 技术和思考，基于issues
...
*   [leandro-rc/vscode-fluent-ui](https://github.com/leandro-rc/vscode-fluent-ui) -

*   [mahmoud-asdf/vscodeCusotmTheme](https://github.com/mahmoud-asdf/vscodeCusotmTheme) - My personal vscode customization
...
*   [cdwilson/dotfiles](https://github.com/cdwilson/dotfiles) - Chris Wilson's dotfiles
...
*   [yingziwu/mastodon](https://github.com/yingziwu/mastodon) - The souce code of bgme.me.
...
*   [qinweizhang/MRI\_music\_pub](https://github.com/qinweizhang/MRI_music_pub) - playing music using the MRI gradient system
...
*   [RepeatedFailure/Sus\_Detection](https://github.com/RepeatedFailure/Sus_Detection) - Using Yolov5 to detect things that look like characters from Among Us.

*   [RepeatedFailure/qr\_convert](https://github.com/RepeatedFailure/qr_convert) - colab notebook to convert images and gifs to qr codes
...
*   [makerjackie/nolebase-template](https://github.com/makerjackie/nolebase-template) - A minimal repo for template. Modify from https://github.com/nolebase/nolebase
...
*   [Lucian-prog/2025-fpga-anlogic-audio-solution](https://github.com/Lucian-prog/2025-fpga-anlogic-audio-solution) - 2025年嵌入式大赛FPGA国赛安路赛题一音频题的方案，摘得全国一等奖

*   [riscv-mcu/e203\_hbirdv2](https://github.com/riscv-mcu/e203_hbirdv2) - The Ultra-Low Power RISC-V Core
...
*   [box-archives/homepage-new](https://github.com/box-archives/homepage-new) - My Profile Page / Homepage

*   [cworld1/astro-theme-pure](https://github.com/cworld1/astro-theme-pure) - ⭐ A simple, fast and powerful blog & document theme built by Astro
...
*   [Besty0728/fuwari](https://github.com/Besty0728/fuwari) - 本仓库来自对fuwari的二次魔改版本的三次魔改
...
*   [tcdw/koi](https://github.com/tcdw/koi) - 为我（曾经）不存在的赛博女儿制作的 Astro 静态博客模板

*   [TatsukiMeng/Blog](https://github.com/TatsukiMeng/Blog) -
...
*   [posit-dev/btw](https://github.com/posit-dev/btw) - A complete toolkit for connecting R and LLMs

*   [r-lib/fs](https://github.com/r-lib/fs) - Provide cross platform file operations based on libuv.

## GLSL

*   [SilentPaltos/Minecraft-HAL-Lighting-VanillaShader](https://github.com/SilentPaltos/Minecraft-HAL-Lighting-VanillaShader) - I don't remember why it is called HAL

*   [lua-gods/flashlight-iris-shader](https://github.com/lua-gods/flashlight-iris-shader) - Flashlight iris shader for minecraft
...
*   [OpenPNGStudio/OpenPNGStudio](https://github.com/OpenPNGStudio/OpenPNGStudio) - Create & stream PNGTuber models | Codeberg Mirror

*   [Book-reader/fox33](https://github.com/Book-reader/fox33) - previously cat64-or-something (see branch main), now fox32 emulator bc I don't have to come up with an architecture design

*   [c3lang/c3c](https://github.com/c3lang/c3c) - Compiler for the C3 language

## HLSL

*   [Filoppi/PumboAutoHDR](https://github.com/Filoppi/PumboAutoHDR) - Advanced ReShade AutoHDR

*   [Blinue/Magpie](https://github.com/Blinue/Magpie) - A general-purpose window upscaler for Windows 10/11.

## Squirrel

*   [p2r3/spplice-repo](https://github.com/p2r3/spplice-repo) - The global Spplice package repository
...
*   [sarcophagus-org/sarcophagus-contracts](https://github.com/sarcophagus-org/sarcophagus-contracts) - Smart contracts for the Sarcophagus Dead Man's Switch system
...
*   [USEPA/EPANET2.2](https://github.com/USEPA/EPANET2.2) - Perform extended-period simulation of the hydraulic and water quality behavior within drinking water distribution systems
...
*   [pgEdge/snowflake](https://github.com/pgEdge/snowflake) - Snowflake Sequences for PostgreSQL

*   [musker91/apiTools](https://github.com/musker91/apiTools) - ApiTools是一个集成各种常用工具，为开发者提供免费、便捷的API接口，方便开发者可以通过API方式快速获取数据

## Smarty

*   [mbaersch/cyrb53-hasher](https://github.com/mbaersch/cyrb53-hasher) - hash strings using a cyrb53 implementation - standard ascii characters only  (Custom Variable Template for Server-Side Google Tag Manager)

## Ada

*   [stcarrez/ada-ado](https://github.com/stcarrez/ada-ado) - Ada Database Objects
...
*   [open-api-spex/open\_api\_spex](https://github.com/open-api-spex/open_api_spex) - Open API Specifications for Elixir Plug applications
...
*   [soirihiroka/bf-jit-rs](https://github.com/soirihiroka/bf-jit-rs) - A Brainfuck JIT compiler written in Rust.
...
*   [Infatoshi/metal-mc-terrain](https://github.com/Infatoshi/metal-mc-terrain) - Native Metal terrain renderer for Minecraft 1.16.5 on Apple Silicon. 10x FPS by replacing macOS OpenGL with Metal.
...
*   [TencentCloud/TIMSDK](https://github.com/TencentCloud/TIMSDK) - Free Chat SDK (IM SDK) — 1,000 MAU/month free forever with push notifications & no concurrency limits. Build in-app messaging with chat API, UIKit & send message. Supports Android, iOS, Flutter, Web, React Native, uni-app, HarmonyOS & more.
...
*   [SteamTracking/GameTracking-CS2](https://github.com/SteamTracking/GameTracking-CS2) - 📥 Game Tracker: Counter-Strike 2
