...
* [VilinkoStudio/Synap](https://github.com/VilinkoStudio/Synap) -

* [davidB/dioxus-iconify](https://github.com/davidB/dioxus-iconify) - CLI tool for importing/vendoring icons from [Iconify](https://icon-sets.iconify.design/) (material, lucid, heroicons,....) or from local SVG files in Dioxus projects

* [pierreaubert/gpui-toolkit](https://github.com/pierreaubert/gpui-toolkit) - A UI toolkit build to on top of Zed GPUI that also works on mobile.

* [pierreaubert/sotf](https://github.com/pierreaubert/sotf) - Optimise the sound of your headphones and speakers
...
* [Zushah/Chalkboard](https://github.com/Zushah/Chalkboard) - A library at the intersection of pure mathematics and web interactivity.

* [bytelab-studio/iconify-cli](https://github.com/bytelab-studio/iconify-cli) - A fast, unofficial command-line tool for searching and downloading icons from the Iconify ecosystem.
